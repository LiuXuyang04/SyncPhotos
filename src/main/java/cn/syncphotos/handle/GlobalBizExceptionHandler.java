...
public class GlobalBizExceptionHandler {
	...
	public R ServletSystemException(ServletException e) {
		log.error(e.getLocalizedMessage(), e);
		return R.failed("请求不合法!");
	}
	...
	@ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
	public R MethodArgumentSystemException(MethodArgumentTypeMismatchException e) {
		return R.failed("请求不合法!");
	}
	...
	public R handleIllegalArgumentException(IllegalArgumentException exception) {
		log.warn("非法参数,ex = {}", exception.getMessage());
